$(document).ready(function(){
	...
	$("#login").click(function(){	
			...
			$.ajax({
				...
				data:{'name':name,'password':password},
		       	url: "http://tres.1920.fpz.com/controller/cSessionVars.php", 
		       	dataType:"text",
		    	success: function(result){ 
	...
	$("#btnLogout").click(function(){	
		...
		$.ajax({
	       	url: "http://tres.1920.fpz.com/controller/cSessionLogout.php", 
	       	dataType:"text",
	    	success: function(result){  
	...
	$('#register').on('click',function(){
		...
		$.ajax({
			...
			data:{'username':username, 'password':password,'name':name,'surname':surname,'email':email,'admin':admin},
	       	url: "http://tres.1920.fpz.com/controller/cInsertNewUser.php", 
	       	dataType:"json",
